...
### 4.5 Cycles (`/hr/cycles`)

| # | Action | Expected | ✓ |
|---|--------|----------|---|
| 1.23 | Tap **+**. Fill name, start/end dates, self- and manager-rate deadlines. Save. | Cycle appears in the list with status. | ☐ |
| 1.24 | On an employee Add/Edit form, set a **Monthly incentive amount** and save, then reopen the employee. | The amount persists and shows on the employee detail screen; clearing it falls back to the org default. | ☐ |
...
| 2.3 | Check the incentive snapshot. | Shows the projected payout from the latest score and the per-employee performance incentive. | ☐ |
